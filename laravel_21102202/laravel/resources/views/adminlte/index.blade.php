...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <!-- Bootstrap 3.3.7 -->
    <script
        src="{{ url('') }}/laravel/vendor/almasaeed2010/adminlte/bower_components/bootstrap/dist/js/bootstrap.min.js">
    </script>
    <!-- Morris.js charts -->
    ...
    <!-- jvectormap -->
    <script src="{{ url('') }}/laravel/vendor/almasaeed2010/adminlte/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js">
    </script>
    <script
